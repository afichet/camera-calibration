...
void MacbethReferenceModel::setIlluminant(
  const float* illuminant_spd, int illuminant_first_wavelength_nm, size_t illuminant_size)
{
...
void MacbethReferenceModel::setCMFs(
  const float* cmf_x, const float* cmf_y, const float* cmf_z, int cmf_first_wavelength_nm, size_t cmf_size)
{
